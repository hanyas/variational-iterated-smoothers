"""Cubic sensor: ELBO and NLPD per iteration, damped hybrid-markov smoother (FH/GSLR, cubature) vs undamped IPLS.

Outputs:
  outputs/fig_cubic_elbo_nlpd_hyb.pdf   -- ELBO (left) and calibration NLPD (right) per iteration
  outputs/results_cubic_elbo_hyb.csv    -- per-iteration ELBO, one column per curve
  outputs/results_cubic_nlpd_hyb.csv    -- per-iteration NLPD, one column per curve

Run from this directory: python exp1_elbo_hyb.py
"""
...
SMOOTHER = "hybrid"                       # other cubic script: "forward"
OUT_SUFFIX = "hyb"                        # other cubic script: "fwd"
HIST_MARGINALS_KEY = "forward_marginals"  # forward smoother: "marginals"
HIST_KERNELS_KEY = "forward_kernels"      # forward smoother: "kernels"
